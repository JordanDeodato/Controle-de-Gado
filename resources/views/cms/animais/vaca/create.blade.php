                    ...
                    <div class="card-body">
                        ...
                        <form class="row g-3">
                            ...
                            <div class="col-md-6">
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="paricoes" placeholder="Parições">
                            ...
                            <div class="col-md-6">
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <input type="date" class="form-control" id="primeira_cria" placeholder="Data 1ª Cria">
                                        <label for="primeira_cria">Data 1ª Cria</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <input type="date" class="form-control" id="ultima_cria" placeholder="Data Última Cria">
                                        <label for="ultima_cria">Data Última Cria</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
